...
<title>THE CARD GAME - はるなあはる - 推しカード</title>
<meta charset="utf-8" />
<meta name="description" content="はるなあはる - 推しカード | THE CARD GAME / カードゲームで遊ぼう！" />
...
<input type="text" name="profileID" value="profileID"><label for= "profileID">profileID</label>
<input type="submit" value="送信" />
</form>

<form method="POST" action="profile.php">
<input type="text" name="profileName" value="名無しのごんべい"><label for= "profileName">profileName</label><br/>
<input type="text" name="profileID" value="harunaaharu"><label for= "profileID">profileID</label><br />
<input type="text" name="cardTitle" value="はるなあはる"><label for= "cardTitle">cardTitle</label><br />
...
<option value="Scean Card">Scean Card</option>
<option value="Action Card">Action Card</option>
<option value="Scenario Card">Scenario Card</option>
</select><br />
<input type="text" name="cardTitle" value="はるなあはる"><label for= "cardTitle">cardTitle</label><br/>
<input type="text" name="cardMessage" value="沖縄生まれ沖縄在住のはるなあはるです。"><label for= "cardMessage">cardMessage</label><br/>

<input type="text" name="cardActivePower" value="３"><label for= "cardActivePower">cardActivePower</label><br/>
<input type="text" name="cardOffensivePower" value="３"><label for= "cardOffensivePower">cardOffensivePower</label><br/>
<input type="text" name="cardDefensivePower" value="３"><label for= "cardDefensivePower">cardDefensivePower</label><br/>
<textarea name="cardDetailsAbility"><a href="https://www.showroom-live.com/zipper0375" target="_blank"><img src="../img/SHOWROOM_logo.svg.png" style="width:100px;"/></a> <a href="https://www.showroom-live.com/room/profile?room_id=107665" target="_blank">https://www.showroom-live.com/zipper0375</a></textarea><label for= "cardDetailsAbility">cardDetailsAbility</label><br/>
...
<div class="front">
<a href="./harunaaharu.html">
<img src="../images/card/harunaaharu.png" style="width:350px;padding:30px;background-color:rgba(255,255,255,0.5);border-radius:6px;" />
</a>
</div>
...
<div id="harunaaharuProfile" class="card_title">
...
<blockquote class="twitter-tweet"><p lang="ja" dir="ltr"><a href="https://twitter.com/hrn_666?ref_src=twsrc%5Etfw">@hrn_666</a> <br>はい、カード化してみました。<br>配信頑張ってください＾＾<a href="https://twitter.com/hashtag/%E3%81%AF%E3%82%8B%E3%81%AA%E3%81%82%E3%81%AF%E3%82%8B?src=hash&amp;ref_src=twsrc%5Etfw">#はるなあはる</a><a href="https://twitter.com/hashtag/SHOWROOM?src=hash&amp;ref_src=twsrc%5Etfw">#SHOWROOM</a><a href="https://twitter.com/hashtag/%E3%82%AB%E3%83%BC%E3%83%89%E3%82%B2%E3%83%BC%E3%83%A0%E3%82%92%E4%BD%9C%E3%82%8D%E3%81%86?src=hash&amp;ref_src=twsrc%5Etfw">#カードゲームを作ろう</a><a href="https://twitter.com/hashtag/THECARDGAME?src=hash&amp;ref_src=twsrc%5Etfw">#THECARDGAME</a><a href="https://t.co/LZy3jGZFBy">https://t.co/LZy3jGZFBy</a><br>SHOWROOMのリンク用のカードを作ってみました。 <a href="https://t.co/o0GplUAbmN">pic.twitter.com/o0GplUAbmN</a></p>&mdash; きゃらあげ素敵曜日チャンネル (@karaage1112) <a href="https://twitter.com/karaage1112/status/1024751026824347648?ref_src=twsrc%5Etfw">August 1, 2018</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
</div>
</td>
</tr>
<tr style="background-color:rgba(255,255,255,0.5);height:50px;">
<th>カードID</th>
<td><a href="./harunaaharu.html#nomal">harunaaharu</a></td>
</tr>
<tr style="background-color:rgba(255,255,255,0.5);height:50px;">
<th>タイトル</th>
<td>はるなあはる</td>
...
<tr style="background-color:rgba(255,255,255,0.5);height:50px;">
<th>詳細</th>
<td><a href="https://www.showroom-live.com/zipper0375" target="_blank"><img src="../img/SHOWROOM_logo.svg.png" style="width:100px;"/></a> <a href="https://www.showroom-live.com/room/profile?room_id=107665" target="_blank">https://www.showroom-live.com/zipper0375</a></td>
</tr>
<tr style="background-color:rgba(255,255,255,0.5);height:50px;">
<th>ハート数</th>
<td><spna id="harunaaharuNomalCardHearts"></span></td>
</tr>

<tr style="background-color:rgba(255,255,255,0.5);height:50px;">
<th>NEXT</th>
<td><spna id="harunaaharuNomalCardNext"></span></td>
</tr>
...
<script>
var harunaaharuNomalCardHearts = document.getElementById("harunaaharuNomalCardHearts");
countHearts(harunaaharuNomalCardHearts,69);
var harunaaharuNomalCardNext = document.getElementById("harunaaharuNomalCardNext");
nextLevel(harunaaharuNomalCardNext,0);
</script>
...
leftButtonDiv.onclick = function leftButton () {
    ...
    + "./harunaaharu.html#" + cardList[card_no].name + '"><img src="' + "../images/card/" + cardList[card_no].img + '" style="width:350px;padding:30px;background-color:rgba(255,255,255,0.5);border-radius:6px;" /></a></div><div class="flipped" style="text-align:center;width:100%;"><a href="' + "./harunaaharu.html#" + cardList[card_no].name + '"><img src="' + "../images/card/" + cardList[card_no].img +  '" style="width:350px;padding:30px;background-color:rgba(255,255,255,0.5);border-radius:6px;" /></a></div></div><a href="../card.html"><h1 style="text-align:center;width:100%;height:600px;">THE CARD GAME</h1></a>';
}
...
<div id="harunaaharuHistory" class="card_title">
...
<tr style="background-color:rgba(255,255,255,0.5);height:50px;">
<td hidden>harunaaharu00001</td>
<td><a href="./harunaaharu.html">harunaaharu</a></td>
<td>ページが更新されました</td>
</tr>
</table>
...
<div id="harunaaharuService"  class="card_title" hidden>
...
<tr style="background-color:rgba(255,255,255,0.5);height:50px;">
<td hidden>harunaaharu</td>
<td>はるなあはる</td>
<td><a href="./harunaaharu.html">詳細を見る</a></td>
</tr>
<tr style="background-color:rgba(255,255,255,0.5);height:50px;">
